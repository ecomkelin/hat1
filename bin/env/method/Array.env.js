 ...
 * 注意 array 不会根据形参变化 最终结果 返回给array 才会真正的变化
 */
 isArrayObjSame = (array, arr, field) => {
    if (!(array instanceof Array)) return -2;
    if (!(arr instanceof Array)) return -2;
...
let objs1 = [{_id: 2, code: "002"}, {code: "003", _id: 3}, {_id: 1, code: "001"}];
let objs2 = [{_id: 1, code: "001"}, {code: "003", _id: 3}, {code: "002", _id: 2, }];
let result = isArrayObjSame(objs1, objs2, "_id");
